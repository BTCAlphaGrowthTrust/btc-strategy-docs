...
description: The Gaia basket object — deploy_pct, static tier weights, deployment_state, and why there is no stop.
...
Gaia is an **accumulation** program. It **holds through drawdowns** — that is the entire point of
